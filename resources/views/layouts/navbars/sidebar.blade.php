        ...
        <ul class="nav">
          ...
          <li>
              <a href="{{ route('apartados.orders') }}">
                  ...
                  <p>{{ __('web.orders') }} <span style="border-radius: 50%;padding: 0.3rem;padding-left: 0.5rem;padding-right: 0.5rem;text-align: center; background: #27283d; margin-left: 1rem">{{App\Order::where('finished',0)->get()->count()}}</span></p>
              </a>
          </li>
